...
Dim nPort
nPort = oShell.Run("cmd /c netstat -ano | findstr :4000 | findstr LISTENING > NUL 2>&1", 0, True)
If nPort = 0 Then
    Response.Write "<p><span class='ok'>checkmark Node.js esta escutando na porta 4000</span></p>"
Else
    Response.Write "<p><span class='err'>times Node.js NAO esta escutando na porta 4000</span></p>"
...
If oFSO.FileExists(sLog) Then
    Dim oFile, sContent, aLines, i, nStart
    Set oFile = oFSO.OpenTextFile(sLog, 1, False, 0)
